...
import type { PlayerTranslationSchema } from '@/shared/api/types.gen';
import {
  AudioLines,
  Captions,
  ChevronLeft,
...
interface TranslationSelectorProps {
  ...
  translations: PlayerTranslationSchema[];
  selectedTranslation: PlayerTranslationSchema;
  setSelectedTranslation: (translation: PlayerTranslationSchema) => void;
}
...
export function TranslationSelector({
  ...
  const getTranslationType = (translation: PlayerTranslationSchema) => {
